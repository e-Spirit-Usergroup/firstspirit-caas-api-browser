                        ...
                        projects.map((project) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell>
                                        {stageOptionTexts[project.stage]}
                                    </TableCell>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                >
                                                    {updatingProjectKey === key
                                                        ? t(
                                                              'app.settings.manageProjects.updatingProject'
                                                          )
                                                        : t(
                                                              'app.settings.manageProjects.updateProject'
                                                          )}
                                                </DropdownMenuItem>
                                                <DropdownMenuItem
                                                ...
                                                >
                                                    {t(
                                                        'app.settings.manageProjects.removeProject'
                                                    )}
                                                </DropdownMenuItem>
                                            </DropdownMenuContent>
                                        </DropdownMenu>
